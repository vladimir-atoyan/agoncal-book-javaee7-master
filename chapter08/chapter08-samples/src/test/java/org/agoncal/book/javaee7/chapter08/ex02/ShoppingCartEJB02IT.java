...
public class ShoppingCartEJB02IT {
    ...
    public void shouldAddTwoItemsToTheShoppingCart() throws Exception {
        ...
        assertNotNull(ctx.lookup(
                "java:global/classes/ShoppingCartEJB02!org.agoncal.book.javaee7.chapter08.ex02.ShoppingCartEJB02"));
        assertNotNull(ctx.lookup("java:global/classes/ShoppingCartEJB02"));

        // Looks up the EJB
        ShoppingCartEJB02 shoppingCartEJB = (ShoppingCartEJB02) ctx.lookup(
                "java:global/classes/ShoppingCartEJB02!org.agoncal.book.javaee7.chapter08.ex02.ShoppingCartEJB02");
