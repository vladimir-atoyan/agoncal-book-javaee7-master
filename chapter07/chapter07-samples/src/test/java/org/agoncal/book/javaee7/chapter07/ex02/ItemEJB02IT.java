...
public class ItemEJB02IT {
    ...
    public void shouldCreateAnItem() throws Exception {
        ...
        ItemEJB02 itemEJB = (ItemEJB02) ctx.lookup(
                "java:global/classes/ItemEJB02!org.agoncal.book.javaee7.chapter07.ex02.ItemEJB02");
        ...
        ItemLocal02 itemLocal = (ItemLocal02) ctx.lookup(
                "java:global/classes/ItemEJB02!org.agoncal.book.javaee7.chapter07.ex02.ItemLocal02");

        // Retrieves all the books from the database
        assertNotNull(itemLocal.findBooks());

        // Looks up the EJB with the remote interface
        ItemRemote02 itemRemote = (ItemRemote02) ctx.lookup(
                "java:global/classes/ItemEJB02!org.agoncal.book.javaee7.chapter07.ex02.ItemRemote02");
